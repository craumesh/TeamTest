		...
		<div class="card-body mx-5 px-0 pb-4">
			<div class="p-0">
				<table id="hr-table"
					...
					<thead>
						<tr>
							<th class="text-center py-3 font-weight-bolder col-2">원자재정보번호</th>
							<th class="text-center font-weight-bolder col-1">원자재코드</th>
							<th class="text-center font-weight-bolder col-1">원자재이름</th>
							<th class="text-center font-weight-bolder col-1">품목카테고리(대)</th>
							<th class="text-center font-weight-bolder col-3">원자재카테고리(소)</th>
