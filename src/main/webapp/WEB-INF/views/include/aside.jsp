       ...
       <li class="nav-item" id="mn_hr">
         <span class="nav-link text-white" style="cursor: default;">인사 관리</span>
 		  <ul class="navbar-nav" id="sm6">
		    <li class="nav-item">
		      <a class="nav-link text-white sm-hv" href="/hr/list">
		        <span class="nav-link-text ms-1">인사 정보</span>
		      </a>
		    </li>
		    <li class="nav-item">
		      <a class="nav-link text-white sm-hv" href="/hr/reglist">
		        <span class="nav-link-text ms-1">인사 승인 관리</span>
		      </a>
		    </li>
		    <li class="nav-item">
		      <a class="nav-link text-white sm-hv" href="${path}/submenu3.html">
