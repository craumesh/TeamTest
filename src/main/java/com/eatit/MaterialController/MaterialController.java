...
public class MaterialController {
	...
	public String materialaddListGET(Model model, Criteria cri) {
	...
	public String materialorderListGET(Model model, Criteria cri) {
...
//	}
	...
	// 거래처 검색 - GET
		...
		public CompanyVO selectCompanyPOST(@RequestParam(name = "company_no", required = false) Integer company_no) throws Exception {
			...
			// 데이터 저장
			CompanyVO companyVO = MaterialService.selectCompany(company_no);
